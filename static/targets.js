(() => {
     ...
     return `<article class="target-result ok" data-domain="${esc(r.domain)}">
       ...
       <div class="target-main">
         ...
         <div class="target-compact-meta">
           <span class="target-pill good" title="${tr('hostStatus','Host status')}">${hostIcon}<span>${tr('host','Host')}</span></span>
 ...
 function renderDetails(d){
   const t=d.target||{},v=d.vps||{},ir=d.iran||{},s=d.sni||{},ping=ir.ping||[],http=ir.http||[];
